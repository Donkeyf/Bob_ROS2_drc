    ...
    while True:
        ...
        if lines_blue is not None:
            ...
            for i in range(0, len(lines_blue)):
                ...
                if theta > np.pi / 2:
                    theta_blue_list.append(theta - np.pi)
                else:
                    theta_blue_list.append(theta)
        ...
        if lines_yellow is not None:
            ...
            for i in range(0, len(lines_yellow)):
                ...
                if theta > np.pi / 2:
                    theta_yellow_list.append(theta - np.pi)
                else:
                    theta_yellow_list.append(theta)
